...
import SendMessageComposer, { createMessageContent, SendMessageComposer as SendMessageComposerClass } from "./SendMessageComposer";
...
export default class MessageComposer extends React.Component<IProps, IState> {
    ...
    private onChange = (model: EditorModel) => {
        ...
        let event;
        if (!model.isEmpty) {
            let content = createMessageContent(model, null, null, this.props.permalinkCreator);
